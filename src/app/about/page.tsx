        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed font-medium">
              Founded in 2006 by SuMeeT in Kathmandu, our workshop focuses sheerly on providing uncompromising quality guitar tech service to local and touring musicians across Nepal and abroad.
            </p>
            <p className="text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed font-medium">
