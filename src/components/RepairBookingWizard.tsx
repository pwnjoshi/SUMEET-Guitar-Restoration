          ...
          {submitted ? (
            <div className="text-center py-8 sm:py-12 space-y-4">
              ...
              <p className="text-xs text-[var(--text-muted)] max-w-md mx-auto leading-relaxed">
                Thank you <strong className="text-[var(--text-main)]">{name}</strong>. SuMeeT Lutherie Workshop has logged your appointment request for <strong className="text-[var(--gold)]">{instrument}</strong>. We will call you shortly on <strong className="text-[var(--text-main)]">{phone}</strong>.
              </p>
              <button
                onClick={() => {
                  setSubmitted(false);
