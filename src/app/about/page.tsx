        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden apple-glass-card border border-[var(--border)] shadow-2xl group">
            <Image
              ...
              alt="SuMeeT Guitar Restoration Workshop Kathmandu"
              fill
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed font-medium">
              Established in 2006 in Kathmandu by SuMeeT, SuMeeT Guitar Restoration focuses sheerly on providing uncompromising quality guitar tech service to local and touring musicians across Nepal and abroad.
            </p>
            <p className="text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed font-medium">
